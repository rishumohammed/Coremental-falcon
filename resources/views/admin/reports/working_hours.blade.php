                ...
                <div class="card-white p-4">
                    <form action="{{ url('admin/reports/working-hours') }}" method="GET" class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="search" list="employee_names" class="form-control"
                                value="{{ request('search') }}" placeholder="Name or ID" autocomplete="off">
                        ...
                        @if(request('view_type') == 'monthly')
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="month" name="month_filter" class="form-control"
                                    value="{{ request('month_filter', date('Y-m')) }}">
                            </div>
                        @else
                            <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="view_type" class="form-control" onchange="this.form.submit()">
                                ...
                                <option value="monthly" {{ request('view_type') == 'monthly' ? 'selected' : '' }}>Monthly
                                </option>
                                <option value="total" {{ request('view_type') == 'total' ? 'selected' : '' }}>Total Summary
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="sort_by" class="form-control">
                                <option value="date" {{ request('sort_by') == 'date' ? 'selected' : '' }}>Date / Period
                                </option>
                                <option value="name" {{ request('sort_by') == 'name' ? 'selected' : '' }}>Employee Name
                                </option>
                                <option value="hours" {{ request('sort_by') == 'hours' ? 'selected' : '' }}>Total Hours
                                </option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="sort_dir" class="form-control">
                                <option value="desc" {{ request('sort_dir') == 'desc' ? 'selected' : '' }}>Descending (Z-A /
                                    Highest / Newest)</option>
                                <option value="asc" {{ request('sort_dir') == 'asc' ? 'selected' : '' }}>Ascending (A-Z /
                                    Lowest / Oldest)</option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3 d-flex align-items-end">
                            <div class="d-flex w-100">
                                ...
                                <a href="{{ url('admin/reports/working-hours') }}" class="btn ui-btn btn-light ml-2 px-3"
                                    title="Reset Filters">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card-white p-3 d-flex justify-content-between align-items-center"
                    ...
                    <div>
                        <h6 class="mb-0 text-success font-weight-bold"><i class="fas fa-clock mr-2"></i>Grand Total Working
                            Hours</h6>
                                        ...
                                        <td>
                                            @if($pair['in'])
                                                <span class="text-success"><i
                                                        class="fas fa-sign-in-alt mr-1"></i>{{ date('h:i A', strtotime($pair['in'])) }}</span>
                                            @else
                                        ...
                                        <td>
                                            @if($pair['out'])
                                                <span class="text-danger"><i
                                                        class="fas fa-sign-out-alt mr-1"></i>{{ date('h:i A', strtotime($pair['out'])) }}</span>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
