...
<div class="container-fluid pt-2">
        ...
        <h5 class="mb-0 text-dark font-weight-bold">Edit Shift</h5>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="card-white p-4">
                <form action="{{ url('admin/shifts/edit/'.$shift->id) }}" method="POST">
                    @csrf
                    <div class="form-group mb-4">
                        <label class="font-weight-bold text-dark">Shift Name</label>
                        <input type="text" name="name" class="form-control" style="background-color: #f8fafc; border: 1px solid #e5e7eb;" value="{{ old('name', $shift->name) }}" required>
                        @error('name')
